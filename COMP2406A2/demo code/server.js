...
http.createServer(function(request, response) {
  ...
  request.on('end', function() {
    ...
    //look for puzzle file in songs directory based on puzzle title
      ...
      if(exists){
        ...
        fs.readFile(puzzleFile, function(err, data) {
          ...
          if (err) {
            ...
            //Change the returnObj to scramble puzzle, scramble fileLines in this code. May need to duplicate code to ensure proper POST
